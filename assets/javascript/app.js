$(document).ready(function () {
  ...
  var questions = [
    ...
    {
      question:
        'who played the mario character in the 1993 movie "super mario bros"',
  ...
  $(document).on("click", "#start", function () {
    $("#timer").prepend(
      "<h2>Time remaining: <span id='timers'>15</span> Seconds</h2>"
    );
    $(".infoDisplay").css("background", "rgba(255,255,255,.9");
